 ...
 */
function PartyCode( { partyCode, isCompact = false, position } ) {
    ...
    return (
        <div className={`absolute ${partyCodePositionStyles} flex h-[clamp(60px,10vmin,70px)] w-[clamp(100px,50vw,200px)] items-center justify-center border-white`}>
            ...
            <span className="text-[clamp(1.25rem,7vw,2.5rem)] font-bold text-white whitespace-nowrap px-2">
                {partyCode}
            </span>
        </div>
    );
